...
export function Button({
  ...
  size = "md",
  className = "",
  ...props // TypeScript warns here because it's a union
}: ButtonProps) {
  const baseStyles =
  ...
  // 🔗 LINK BUTTON
  // By checking 'href' in props, we "narrow" the type
  ...
  // 🔘 NORMAL BUTTON
  // We cast to ButtonAsButton to ensure onClick and type are recognized correctly
